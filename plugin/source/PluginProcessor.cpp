...
{
	// Pre-playback initialization
	juce::ignoreUnused(sampleRate, samplesPerBlock);
}

void AudioPluginAudioProcessor::releaseResources()
{
	// After playback stops, clean up any resources, free memory, etc.
}
...
{
	// Use this method to restore your parameters from this memory block, whose
	// contents will have been created by the getStateInformation() call.
